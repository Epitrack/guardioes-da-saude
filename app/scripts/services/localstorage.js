...
angular.module('gdsApp')
    .service('LocalStorage', function($rootScope) {
        ...
        obj.isFirstAccess = function() {

            if (window.localStorage.getItem('gdsfirst') === null && window.localStorage.getItem('gdsfirst') !== moment().format('D/MM/YYYY')) {
                window.localStorage.setItem('gdsfirst', moment().format('D/MM/YYYY'));
                return true;
            }
            return false;
        };
