 ...
 */
angular.module('gdsApp').controller('ChooseSymptomsCtrl', ['$scope', '$translate', 'Surveyapi', '$location', 'LocalStorage', '$timeout', '$window', '$facebook', 'Notification', '$rootScope', 'moment', 
    function($scope, $translate, Surveyapi, $location, LocalStorage, $timeout, $window, $facebook, Notification, $rootScope, moment) {
        ...
        $scope.countries = [
            {
              "nome_pais": "Qual país?",
              "nome_pais_init": "Which coutry?",
              "nome_pais_es": "¿Cual país?",
              "nome_pais_ch": "哪個國家？",
              "nome_pais_ar": "أي دولة؟",
              "nome_pais_ru": "Какая страна?",
              "nome_pais_fr": "Quel pays?"
            },
            {
