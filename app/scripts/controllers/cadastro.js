...
angular.module('gdsApp')
  .controller('CadastroCtrl', ['$scope', '$firebaseAuth', 'UserApi', 'toaster', '$location', 'LocalStorage', '$filter', function ($scope, $firebaseAuth, UserApi, toaster, $location, LocalStorage, $filter) {
