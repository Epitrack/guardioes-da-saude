 ...
 */
angular.module('gdsApp').controller('IndexCtrl', ['$scope', '$translate', 'LocalStorage', '$rootScope', '$location', 'Notification', '$window', 'UserApi',
    function($scope, $translate, LocalStorage, $rootScope, $location, Notification, $window, UserApi) {
