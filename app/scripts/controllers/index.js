 ...
 */
angular.module('gdsApp').controller('IndexCtrl', ['$scope','UserApi', '$translate', 'LocalStorage', '$rootScope', '$location', 'Notification', '$window',
    function($scope, UserApi, $translate, LocalStorage, $rootScope, $location, Notification, $window) {
